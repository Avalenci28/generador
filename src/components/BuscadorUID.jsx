...
export default function BuscadorUID({ onConfirmar }) {
  ...
  const buscarJugador = async () => {
    ...
    try {
      ...
      setError('No se encontró esa cuenta. Verifica el UID e intenta de nuevo.');
    } finally {
  ...
  return (
    <div className="buscador-card">
        ...
        <div className="result show">
          <div className="name-row">
            ...
            <div>
              ...
              <div className="meta">
                {player.level ? `Nivel ${player.level}` : ''}
              </div>
            </div>
          </div>
      ...
      <p className="note">Búsqueda automática en varias regiones.</p>
    </div>
  );
}